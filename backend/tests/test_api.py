#!/usr/bin/env python3
"""
Test script to verify the Todo API authentication and functionality.
"""
import asyncio
import httpx
import json
...
async def test_api():
    print("Testing Todo API functionality...")
    ...
    async with httpx.AsyncClient(base_url=BASE_URL) as client:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print("\n4. Testing /auth/me endpoint with valid token...")
                ...
                print("\n8. Testing unauthorized access (without token)...")
                try:
