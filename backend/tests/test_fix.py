...
BASE_URL = "http://localhost:8001"  # Changed to port 8001
...
try:
    registration_data = {
        "email": "testuser2@example.com",  # Changed email to avoid conflict
...
try:
    login_data = {
        "username": "testuser2@example.com",  # Changed to match new user
        "password": "securepassword123"
    }
